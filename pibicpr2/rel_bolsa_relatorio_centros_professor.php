...
$sql = "select count(*) as total, pibic_professor.pp_centro as pa_centro from pibic_bolsa_contempladas ";
...
while ($line = db_read($rlt))
	...
	$tot2 = $tot2 + 1;
	$href = '<A HREF="rel_bolsa_relatorio_centros_professor_detalhe.php?dd2='.$dd[2].'&dd3='.trim($line['pa_centro']).'">';
	$sx .= '<TR '.coluna().'>';
	$sx .= '<TD>'.$href.$line['pa_centro'].'</A></TD>';
