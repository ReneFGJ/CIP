...
echo '<CENTER><font class=lt5>Planos sem resumo enviados</font></CENTER>';
...
//				echo '==>'.$dt.'=='.$line['pb_protocolo'];
				if ((($dt < 20000101) and ($dd[5] == '1')) or ($dd[5] == '2'))
					{
					$id++;
