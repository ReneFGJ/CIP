...
$sql = "select pp_escola as pp_centro, centro_nome, sp_descricao,sp_ordem,count(*) as total,doc_tipo,doc_status, doc_ano, doc_edital from ".$tabela." ";
...
$sql .= " and (doc_ano = '".$ano."') ";
$sql .= " group by doc_ano,  pp_escola, centro_nome, doc_edital, doc_tipo,sp_descricao,sp_ordem,doc_status ";
