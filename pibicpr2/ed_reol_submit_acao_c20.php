<?
				...
				$nome = '';
				$emailpara = array();
				$xsql = "select * from pareceristas where us_codigo = '".$dd[20]."' ";
				$xrlt = db_query($xsql);
				...
				$lk = $http_site.'parecerista_parecer.php?dd0='.$dd[0].'&dd1='.p($dd[0].$dd[20]).'&dd2='.$dd[20];
				...
				global $eamil_adm, $admin_nome;
				$email_adm = $emailadmin;
