...
array_push($menu,array('Comunicacao','__e-mail de professores SS','comunicacao_email_professores_ss.php'));
array_push($menu,array('Comunicacao','__enviar email','mensagens_email_comunicacao.php'));
