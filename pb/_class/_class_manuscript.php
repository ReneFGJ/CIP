...
class manuscript {
	...
	function resume() {
		...
		while ($line = db_read($rlt)) {
			...
			switch($sta) {
				case '@' :
					$res[0] = $res[0] + $total;
					$linkx[0] = '<A href="' . $page . '&dd1=@" class="linkG">';
					break;
				case 'A' :
					$res[1] = $res[1] + $total;
					$linkx[1] = '<A href="' . $page . '&dd1=A" class="linkG">';
					break;
				case 'N' :
					$res[4] = $res[4] + $total;
					$linkx[4] = '<A href="' . $page . '&dd1=N" class="linkG">';
					break;
				case 'X' :
					$res[6] = $res[6] + $total;
					$linkx[6] = '<A href="' . $page . '&dd1=X" class="linkG">';
					break;
				case 'L' :
					$res[3] = $res[3] + $total;
					$linkx[3] = '<A href="' . $page . '&dd1=L" class="linkG">';
					break;
				case 'B' :
					$res[2] = $res[2] + $total;
					$linkx[2] = '<A href="' . $page . '&dd1=B" class="linkG">';
					break;
				case 'E' :
					$res[2] = $res[2] + $total;
					$linkx[2] = '<A href="' . $page . '&dd1=B" class="linkG">';
				...
				case 'Z' :
					$res[5] = $res[5] + $total;
					$linkx[5] = '<A href="' . $page . '&dd1=Z" class="linkG">';
					break;
				default :
					echo '==' . $sta . '==';
					break;
	...
	function resume_list($status = '') {
		...
		$wh = " doc_status = '$status' ";

		if ($status == 'B') {
			$wh = " doc_status = 'B' or doc_status = 'C' or doc_status = 'E' ";
		}
		$jidr = strzero($jid, 7);
