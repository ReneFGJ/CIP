	...
	function idiomas()
		{
			...
			$sx .= '<UL>';
			$sx .= '<LI><A HREF="'.http.'pb/index.php/'.$path.'?idioma=pt_BR&dd0='.$dd[0].'&dd99='.$dd[99].'">PORTUGUÊS</A></LI>';
			$sx .= '<LI>|</LI>';
	...
	function cp()
		{
			...
			array_push($cp,array('$O pt_BR:Portugues&en_US:Ingles&es:Espanhol&fr:Francês','pij_language','Linguage',True,True));
