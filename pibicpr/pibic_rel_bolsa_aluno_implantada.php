...
echo '<BR><BR>';
echo '<CENTER><font class="lt4">Bolsas Implantadas</font></CENTER>';
echo '<table border="0" width="650" align="center" class="tabela00 lt2">';
...
echo '<BR><BR>';
echo '<CENTER><font class="lt4">Bolsas Implantadas sem efetivação</font></CENTER>';
