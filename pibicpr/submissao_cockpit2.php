...
$modalidade = $dd[0];
echo '</BR>';
	echo '<h3>Submissão de planos por escola</h3>';
	echo $pj->resumo_planos_centro2($ano,$modalidade); 
	
	
	//echo $pj->resumo_planos_campi2();
	//echo $pj->resumo_projetos_area2();
	//echo $pj->resumo_planos_area_conhecimento2();
	///echo $pj->resumo_planos_area2();
	//echo $pj->resumo_planos_area_estrategica2();
