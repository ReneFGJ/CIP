...
//	$hb .= ' Bolsa de Iniciação Científica concedida a projetos em áreas estratégicas</TD>';
	...
	$relatorio_titulo = "Edital PIBITI ".date("Y")."/".(date("Y")+1)." - Resultado do Processo de Seleção de Bolsas de Iniciação Científica";
	$edital = new projetos;	
	
}
echo $edital->mostra_edital_email(date("Y"),$dd[3].$dd[0],$dd[1],$dd[4]);
?>
