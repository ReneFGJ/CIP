...
if ($dd[2]=='DECLINAR')
	{
		$sql = "update pibic_bolsa_contempladas set pb_relatorio_parcial_correcao_nota = -99
		...
		if ($prof == $dd[1])
			{
				...
				$sql = "update pibic_bolsa_contempladas 
						set pb_relatorio_parcial_nota = -90
...
if ($dd[3]=='RPAC')
{
	...
	echo $pari->avaliador_idicar_correcao_form($proto,$area,'RPAC');
...
if (strlen($dd[3]) == 0)
{
	...
	echo $pari->avaliador_idicar_form($proto,$area,'RPAR');
