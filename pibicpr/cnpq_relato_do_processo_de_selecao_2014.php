...
?>
<h1 align="center">RELATO DO PROCESSO DE SELEÇÃO</h1>
<span class="corpo-texto-explicativo">
<ul>
  <li>Implementação do Banco de Avaliadores Externos, iniciado em 2009.
Atualmente com 167 pesquisadores externos, dos quais 76 são 
bolsistas produtividade.</li>
  <li>Ampliação dos Membros do Comitê Local para 60 membros e dos
avaliadores Ad hoc da PUCPR para 200, professores dos programas 
de pós-graduação stricto sensu.</li>
  <li>Implementação do Comitê Gestor com um membro representante
...
programas: PIBIC, PIBITI e PIBIC Jr.</li>
  <li>A evolução da demanda de planos de trabalhos dos alunos para
...
<table class="tabela00" width="60%" align="center">
  <tr align="center">
    <th>ANO</td>
    <th>Ano  Planos alunos <br />
    submetidos  PIBIC</td>
    <th>Planos alunos<br />
    submetidos PIBITI</td>
    <th>TOTAL</td>
  </tr>
  <tr>
...
<li>   
No  PIBIC, a demanda bruta foi de 1.300 planos de trabalhos, a
demanda qualificada de 1.238 e a demanda atendida de 437 bolsas 
(87 CNPq, 350 PUCPR).
</li>
...
<table class="tabela00" width="60%" align="center">
  ...
  <tr>
    ...
    <td class="tabela01" align="center">374</td>
...
<TR>
  ...
  <td class="tabela01" align="center"><strong><span class="tabela01">1549</span> </strong>  
  <td class="tabela01" align="center"><strong>55</strong>  
  <td class="tabela01" align="center"><strong>4,3%
  </strong>
</table>
<ul>
  <li>Regras de Distribui&ccedil;&atilde;o das <strong>Bolsas do PIBIC</strong>:
    <ul>
...
<ul>
      <li> bolsistas DT em Pesquisa do CNPq que tiverem propostas aprovadas;</li>
      <li>ordem de classifica&ccedil;&atilde;o por Grande &Aacute;rea de Conhecimento;</li>
      <li>bolsa CNPq para doutores preferencialmente vinculados ao  stricto sensu; </li>
      <li>at&eacute; 2 bolsas para cada professor, n&atilde;o repetindo do mesmo &oacute;rg&atilde;o de fomento.  </li>
    </ul>
