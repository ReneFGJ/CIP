...
$relatorio_titulo = "Edital Inclusão Social - Fundação Araucária ".date("Y")."/".(date("Y")+1)." - Resultado do Processo de Seleção";
$edital = new projetos;
?>
...
<TABLE width="100%">
	<TR>
		...
		<img src="../img/logo_ic_inclusao.png" height="80" alt="" border="0">
		</TD>
...
<?
	...
	$hb .= '<TD><NOBR><img src="img/logo_bolsa_N.png" width="34" height="15" alt="" border="0"> Inclusão Fundação Araucária';
...
//	$hb .= ' Bolsa de Iniciação Científica concedida a projetos em áreas estratégicas</TD>';
	...
	require($include.'sisdoc_autor.php');
	echo '11';
	$relatorio_titulo = "Edital Inclusão Social ".date("Y")."/".(date("Y")+1)." - Resultado do Processo de Seleção";
	$edital = new pibic_projetos;	
		
}
echo $edital->mostra_edital_email(date("Y"),$dd[3].$dd[0],$dd[1],'N');
?>
