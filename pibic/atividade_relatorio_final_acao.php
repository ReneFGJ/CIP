...
$rtipo = "relatório final";
$fld = "pb_relatorio_final";
$fld_nota = "pb_relatorio_final_nota";
$rtipoc ="RFINAL";
$link = 'atividade_relatorio_final_acao.php';
$ic_msg = 'PIBIC_CPFIM';

$sql = "update pibic_bolsa_contempladas set ";
$sql .= " pb_relatorio_final = 0, pb_relatorio_parcial_nota = 1, pb_relatorio_final_nota = 0 ";
$sql .= " where id_pb = 1446 ";
//$rlt = db_query($sql);

$sql = "update pibic_bolsa_contempladas set ";
$sql .= " pb_relatorio_final = 0, pb_relatorio_parcial_nota = 1, pb_relatorio_final_nota = 0 ";
$sql .= " where id_pb = 1448 ";
//$rlt = db_query($sql);
...
if ($line = db_read($rlt))
	...
	<?
	$sql = "select * from ic_noticia where nw_ref = 'PIBIC_RELFIM' ";
	$rrr = db_query($sql);
	?>
	<br/>
