...
$sr .= $nl . '<CENTER><FONT CLASS="lt4">Resumo do projeto - PIBITI</FONT></CENTER>';
...
if ($ed_acao != false)
	...
	$sr .= $nl . '	<input type="submit" name="xb" value=" Cadastrar plano do aluno '.chr(13).chr(10).' PIBITI" style="height:60px; background-color:#e6f2ff;">';
	$sr .= $nl . '	<input type="hidden" name="dd0" value="00042">';
	...
	$sr .= $nl . '	<form action="'.$link.'"><input type="submit" name="xb" value=" Cadastrar plano do aluno '.chr(13).chr(10).' PIBITjr." style="height:60px; background-color:#e6f2ff;">';
	$sr .= $nl . '	<input type="hidden" name="dd0" value="00043">';
	$sr .= $nl . '	<input type="hidden" name="dd98" value="1">';
	$sr .= $nl . '	</Form></TD>	';
	$sr .= $nl . '	</TR>';
	$sr .= $nl . '</TABLE>';
