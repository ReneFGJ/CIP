...
<TD align="left">
<center><img src="img/logo_pibit.jpg" width="423" height="52" alt="" border="0"></center>
...
$sql .= " and sp_codigo = '00041' ";
$sql .= " order by sp_ordem limit 5 ";
$qrlt = db_query($sql);
$bto = array();
...
while ($line = db_read($qrlt))
	...
	$s .= '<TD>';
	$s .= '<form method="post" action="submit_phase_1_pibiti_sel.php">';
	$s .= '<TD align="right">';
