...
//		$ss .= '<TR><TD><fieldset><legend>&nbsp;<B><font color="blue">Submissão de Projeto e Plano de Aluno</font></B>&nbsp;</legend>';	
		$ss .= '<TR><TD><fieldset><legend>&nbsp;<B><font color="blue">Submissão de Projeto e Plano de Aluno</font></B>&nbsp;</legend>';	
		...
		array_push($menu,array('Projetos','Submissão de novo projeto','submit_phase_0.php')); 
...
//	$ss .= '<form method="post" action="submit_phase_1_pibic.php">';
	...
	echo $ss;
		...
		$sn .= '<CENTER><font class="lt3"><font color="#FF8040"><B>SUBMISSÃO DE PROJETOS: ENCERRADA</B></font></font></CENTER>';
}
