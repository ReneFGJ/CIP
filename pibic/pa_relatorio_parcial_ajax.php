...
if (($dd[2]) == 'idioma_alterar')
	...
	echo 'var tela01 = $.ajax( "pa_relatorio_parcial_ajax.php?dd1='.$dd[1];
...
if (($dd[2]) == 'files_del')
	{
		...
		echo $ged->file_list();
			...
			$sx .= '    var tela01 = $.ajax( "pa_relatorio_parcial_ajax.php?dd1='.$dd[1].'&dd2=files&dd3='.$frame.'&dd90='.$dd[90].'" ) .done(function(data) { $("#'.$frame.'").html(data); }) .fail(function() { alert("error"); }) .always(function(data) { $("#'.$frame.'").html(data); }); '.chr(13);
			$sx .= '</script>'.chr(13);				
			echo $sx;	
