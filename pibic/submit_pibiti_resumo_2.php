...
//	$sql .= "inner join ".$submit_manuscrito_field." on sub_codigo = spc_codigo ";
	...
	while ($line = db_read($xrlt))
		...
		if (strlen($pp_titulo) > 1)
			...
			$sr .= $nl . '<TR bgcolor="#FFFFFF"><TD rowspan="6" width="74"><img src="/reol/pibicpr/img/icone_pibic_jr.png" alt="" border="0"></TD><TH colspan="2" bgcolor="C0C0C0">Plano de trabalho PIBITI Jr. (Estudante)</TH></TR>';
