...
Prezado Avaliador
<BR><BR>
Nos últimos dois anos, o Comitê Externo do CNPq durante avaliação da PUCPR no SEMIC, indicou parecer favorável no quesito institucional, mas <B>precisando melhorar</B>  no quesito <B>qualidade da pesquisa</B>.
<BR><BR>
Frente a esta indicação,  o Comitê Gestor dos programas PIBIC e PIBITI introduziu na ficha de avaliação do relatório final duas alternativas relevantes que devem auxiliar a identificar tanto os melhores trabalhos para a premiação como também as pesquisas com problemas.
<BR><BR>
Caso o sr. considere que o relatório final apresenta problemas importantes na condução da pesquisa realizada ou na apresentação dos resultados, assinale a alternativa: "<B>não indicado para apresentação pública no SEMIC</B>" e pedimos que justifique seu parecer no respectivo campo. Este relatório será analisado novamente pelo Comitê Gestor do Programa.
<BR><BR>
Cabe ainda ressaltar que todos os professores orientadores receberão o parecer  da avaliação do relatório final. Agradecemos imensamente sua participação e colaboração.
<BR><BR>
Coordenação da IC
<BR><BR>
');
...
$form_title = '<BR><B>Ficha de Avaliação do Relatório Parcial PIBIC_EM (Jr)</B>';
