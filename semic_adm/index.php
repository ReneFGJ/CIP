...
/////////////////////////////////////////////////// MANAGERS
	...
	array_push($menu,array('Anais do Seminário','Trabalhos','semic_apresentacao.php'));
	...
	array_push($menu,array('Anais do Seminário','Inserir autores sem nome','semic_autores_inserir.php'));
