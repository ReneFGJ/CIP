...
require($include.'sisdoc_debug.php');
	...
	echo '<BR>';
	echo $pibic->orientacao_pibic($programa_pos,$areas,$programa_pos_anoi,$programa_pos_anof);
	echo $pibic->orienacao_pibic_programa($programa_pos,$areas,$programa_pos_anoi,$programa_pos_anof);
	//resumo_qualis_ss
