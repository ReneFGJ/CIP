...
require($include.'sisdoc_debug.php');
	...
	$http_ver = 'bonificacao_desmembrar.php'; 
	$editar = False;
	$http_redirect = page();
	$clx->row();
	$busca = true;
	...
	echo '<h3>Desmembrar pagamento para mais de um pesquisador<h3>';
	echo '<font color="#404040">';
	echo '<P>Divide o pagamento da bonificação quando o 
			valor é rateado em mais de um pesquisador. Clique em
