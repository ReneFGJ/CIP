...
array_push($menu,array('Captação de recursos','captacao.php'));
array_push($menu,array('Isenção de Bolsas (SS)','bolsas.php'));
...
if ($user_nivel >= 9)
	{ 
	array_push($menu,array('Declarações','main.php')); 
	}
	
if ($user_nivel >= 9)
	{ 
	array_push($menu,array('Mensagens','main.php')); 
	array_push($menu,array('Manutenção','main.php'));
	}
