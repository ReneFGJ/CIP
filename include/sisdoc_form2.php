...
?>
<script type="text/javascript" src="<?php echo $include;?>js/jquery.js"></script>
...
function gets($c1,$txt,$c3,$c4,$c5,$c6=0)
	{
	global $estilo,$acao,$editor,$ed_nr_id,$script,$vcol,$max_char,$http;
...
//		$gets = $gets . '<input type="text" name="'.$c1."\" value=\"".$txt."\" size=\"".$size."\" maxlength=\"".$mvl."\" ".$ce."></TD>";
		...
		$gets .= '<img src="'.$http.'/include/img/icone_calender.gif" border="0" id="'.$c1.'a" style="cursor: pointer; border: 0px solid red;" title="Seleção de data" onmouseover="this.style.background='.chr(39).'red'.chr(39).';" onmouseout="this.style.background='.chr(39).chr(39).'" >';
		/* SCRIPT */
