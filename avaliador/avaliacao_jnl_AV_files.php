...
///////////////////////////////////////// Parte III - Arquivos Anexos
	...
	$sql .= " where pl_codigo = '".$protocolo."' and pl_all = 1";
...
//		{ print_r($xline); echo '<HR>'; }
	...
	while ($line = db_read($rlt))
		...
		$link = '<A HREF="javascript:newxy(\'../editora/download_submit.php?dd0='.$line['id_pl'].'&dd1=download&dd2='.$chk.'&dd3='.date("Hmi").'\',300,150);">';
