					...
					if ($cp[$r][1]=='pp_p01')
						{
							...
							if ($dd[$r]==5) { $text = 'Aprovado, porém necessita adequações para apresetação no SEMIC, não necessita reenviar para análise.'; }
							if ($dd[$r]==2) { $text = 'Relatório Final está com pendências, precisa ser corrigido e reenviado.'; }
							if ($dd[$r]==-1) { $text = 'Relatório não aprovado e não indicado para apresentação pública no XXI SEMIC.'; }							
						}
