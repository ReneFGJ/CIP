...
$cap = $sp.'3)	Os itens descritos na questão 2 (se aplicável) poderão ser corrigidos até a apresentação do SEMIC?';
$opc  = 'sim:sim<BR>';
$opc  .= '&não:não<BR>';
...
$opc .= '2:<font color=red>Necessita correções para o relatório final.</font>';
