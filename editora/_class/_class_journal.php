		...
		function cp_parecer()
			{
				...
				array_push($cp,array('$Q pm_nome:pm_codigo:select * from parecer_model  where pm_ativo = 1 order by pm_nome','jn_parecer','Modelo de parecer de avaliação',False,True,''));
				array_push($cp,array('$Q pm_nome:pm_codigo:select * from parecer_model  where pm_ativo = 1 order by pm_nome','jn_parecer','Modelo de parecer de reavaliação',False,True,''));
