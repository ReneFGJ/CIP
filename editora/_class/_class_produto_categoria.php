...
class categoria
	{
	var $tabela = "fomento_categoria";
	var $tabela_categoria = "fomento_categorizacao";
	...
	function row()
		{
			global $cdf,$cdm,$masc;
			$cdf = array('id_ct','ct_descricao','ct_codigo','ct_main');
	...
	function cp()
		{
			...
			array_push($cp,array('$[1-20]','ct_ordem','Ordem',True,True));
