...
echo '<TD align="right" width="200"><nobr>';
...
echo '</A>';
echo '<A HREF="doaj_xml.php?dd0=' . $issue_id . '" target="_new' . $issue_id . '">';
echo '<img src="img/icone_doaj.png" height="40" title="XML para o DOAJ" aling="right">';
echo '</A>';
echo '</table>';
