...
class parecerista {
	...
	function parecerista_ultimos_aceites() {
		...
		while ($line = db_read($rlt)) {
			...
			switch ($sta) {
				case '0' :
					$sx .= '<font color="red">Não aceito</font>';
					break;
				case '10' :
					$sx .= '<font color="green">Aceito</font>';
					break;
				default :
					$sx .= '???? - ' . $sta;
					break;
	...
	function status() {
		$ar = array('1' => 'Convite aceito', '2' => 'Aguardando resposta', '3' => 'Recusado temporariamente', '9' => 'Enviar convite', '-1' => 'Excluir', '0' => 'Não, convite não aceito', '19' => 'Convite novo enviado', '10' => 'SIM, Convite Novo Aceito', '11' => 'Convite aceito via CNPq');
		return ($ar);
	}
