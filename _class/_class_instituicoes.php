		...
		function cp()
			{
				...
				array_push($cp,array('${','','Coordenadas (latitude e longitude)',False,False,''));
				array_push($cp,array('$S25','inst_lat','Latitude',False,True,''));
				array_push($cp,array('$S25','inst_log','Longitude',False,True,''));
				array_push($cp,array('$}','','Coordenadas (latitude e longitude)',False,False,''));
