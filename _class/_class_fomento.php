...
/* parte 5 */
	...
	function mostra() {
		...
		if ($idioma == 'FR') {
			$cab = array('fomento_1' => 'Objectifs', 'fomento_2' => 'Dépenses admissibles', 'fomento_3' => 'Conditions d´admissibilité', 'fomento_4' => 'Contact', 'fomento_5' => '#(5)', 'fomento_6' => 'Secteurs prioritaires', 'fomento_7' => '#(7)', 'fomento_8' => '#(8)', 'fomento_9' => '#(9)', 'fomento_10' => '#(10)', 'fomento_11' => 'Présentation des projets', 'fomento_12' => 'Contact', 'deadline1' => 'Appel à candidatures ouvert jusqu´au', 'deadline2' => 'Appel à candidatures ouvert jusqu´au', 'deadline3' => 'Predicting outcomes', 'deadline4' => 'Documents and/or institutional signatures<BR> must be requested within 3 working days before the deadline', 'access1' => 'Pour informations supplémentaires cliquez ', 'access2' => 'ICI');
		}
		for ($r = 1; $r <= 12; $r++) {
	...
	function cp() {
		...
		array_push($cp, array('$O 0:Não&1:Sim', 'ed_fluxo_continuo', 'Fluxo continuo', True, True));		
