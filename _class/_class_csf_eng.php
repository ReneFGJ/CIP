	...
	function estudante_area()
			{
				...
				$sx .= '
    				...
    				<script type="text/javascript">
            			...
            			draw(data, {title:"Studants of Course"});
	...
	function estudante_curso()
			{
				...
				$sx .= '<BR><BR><H2>'.msg('List of courses').'</H2>';
				...
				$sx .= '<TR colspan=2>
							...
							Total of <strong>'.$tot_alunos.'</strong> students,';
				$sx .= 	  '  in <strong>'.$tot_cursos.'</strong> courses.';
				$sx  .= '</table>';
				$sx .= '<BR>';				
    			return($sx);
		}
 ...
 */	
	function world_mapa_estudantes()
			...
			$sx .= '
				<form method=POST name="mapas" id="mapas">	
			        <section>
			          <div class="tabs tabs-style-iconbox">
	                    <nav>
	                      <ul>
	                       <li><button id="botao1"> <a href="'.page().'?dd1=world#section-iconbox-1">All</a></button></li>
							<li><button id="botao1"><a href="'.page().'?dd1=021#section-iconbox-1">North America (113)</a></button></li>
							<li><button id="botao1"><a href="'.page().'?dd1=142#section-iconbox-1">Asia (6)</a></button></li>
							<li><button id="botao1"><a href="'.page().'?dd1=150#section-iconbox-1">Europe (142)</a></button></li>
                ...
                $sx .= '<BR><BR><H2 style="text-align:left">Destination countries of our students</H2>';
				$sx .= '<BR>';
				$sx .= '<table width=100% style="text-align:left" class="tabela01">';
				$sx .= '<TR>';
				$sx .= '<TH width=10%  style="text-align:center">Countries<TH width=35%>Institution<TH width=5%>Students';
				$sx .= '<TH width=10%  style="text-align:center">Countries<TH width=35%>Institution<TH width=5%>Students';
				$sx .= $sq.'</table>';
				$sx .= '<BR>';
				$sx .= '<table width=100%  class="tabela00">';
				$sx .= '<TR>
							...
							Total of <i>'.$tot_instit.'</i> institution destination exchange';
				$sx .= 	    " with <i>".$tot_alunos."</i> students sent by the PUCPR.";
				$sx  .= '</table>';	
				$sx .= '<BR>';
				return($sx);				
			}
