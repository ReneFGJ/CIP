...
class header {
	...
	/* About this site */
	var $title = 'IC - Avaliador de Iniciação Científica';
	var $description = '';
	var $http = '';
	var $path = '';
	...
	function head() {
		...
		/* Add Style File */
		$style = array('prj_style.css', 'font_roboto.css', 'google_css.css' , '../../css/style_body.css', '../../css/style_botao.css', '../../css/style_table.css');
	...
	function cab() {
		...
		$sx .= $this -> api_google;
		$sx .= '<div id="cab">';
		$sx .= '<div style="padding: 10px;">';
		$sx .= '<font color="white" font-face="CICPG" style="font-size: 20px;">';
		$sx .= 'Avaliador Iniciação Científica';
		$sx .= '</font>';
		$sx .= '</div>';
		$sx .= $this->menu_top();
		$sx .= '</div>';
