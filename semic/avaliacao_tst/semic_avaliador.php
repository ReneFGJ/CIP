...
/* recupeda dados do avaliador */
//if ($hd->recupera_avalidor() == 1)
//	{
//		redirecina('semic_trabalhos.php');
//		exit;
//	}
...
if ($form_id_av->saved > 0){
	...
	$valida =  ($hd->valida_avaliador($idAvaliador));
	if (round($valida) > 0)
		{
			if ($hd->set_avaliador($hd->avaliador)==1)
				{			
					redirecina('semic_trabalhos.php');
				} else {
					echo 'ERRO';
			...
			$banner_erro = '<font color="red">Código inválido</font>';	
		}
