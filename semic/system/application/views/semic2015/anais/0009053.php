<div id="trabalho">
	<table width="100%" border=0>
		...
		<tr>
			<td colspan=2 class="lt3"><font class="lt6">DIRpr11</font>
	...
	<table width="100%">
		<tr valign="top">
			...
			<div style="text-align:justify;">
				<P>
					<B>Introdução</B>: O estudo comparado das instituições sindicais do Brasil e de Portugal detecta que sofreram inúmeras transformações no decorrer de sua criação até a atualidade como na sua estrutura, na liberdade de associação,  a imunidade dos membros sindicais, bem como as legislações e os princípios norteadores do sindicalismo. Transformações essas ocorridas com o objetivo de garantir os direitos fundamentais no trabalho, visando a melhores condições de vida dos assalariados, a assistência a integrantes da categoria sindicalizada. O sindicalismo desde sua criação até a atualidade continua imaturo, permanece o desenho inicial da organização sindical no Brasil: a unicidade sindical. Em Portugal reina o pluralismo sindical.					<B>Objetivo</B>: O propósito destas linhas consiste em averiguar se comparações encontram guarida na estrutura sindical, imunidade dos membros sindicais, na liberdade de associação e legislações.					<B>Metodologia</B>: Realizou-se uma pesquisa bibliográfica qualitativa no campo da legislação, da doutrina e de sítios da internet sobre o sindicalismo em sua origem, estrutura, autonomia e comparativos dos países em questão, demonstrando as diferenças nos princípios que regem essas instituições como a origem, legislações, princípios da unicidade sindical e a manutenção dos sindicatos.					<B>Resultados</B>: É mister que seja revista  a estrutura do sindicalismo no Brasil, sua forma de custeamento e que os atores do universo do trabalho trilhem em condições de paridade no universo jurídico.					<B>Conclusões</B>: Depreende-se que a estrutura  imposta à luz do Texto Maior de 1988, reservam-se aos sindicatos algumas prerrogativas  como o direito de administrá-lo sem a intervenção estatal, não se pode ter outro sindicato da mesma categoria, fazendo jus ao princípio da unicidade sindical. Aliado a essas prerrogativas emerge a modalidade de como os sindicatos são financiados.  Acentua-se que desde o nascimento, o movimento continua imaturo, dependente de contribuições arrancadas compulsoriamente dos trabalhadores e empresas não associadas. Em Portugal, as instituições sindicais  são mais atuantes, prima pelo assistencialismo aos trabalhadores, tem o viés da pluralidade sindical.				</P>
			</div><B>Palavras-chave</B>: Sindicalismo. Brasil. Portugal.			<BR>
			<BR>
