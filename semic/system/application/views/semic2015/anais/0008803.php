<div id="trabalho">
	<table width="100%" border=0>
		<tr valign="top">
			<td colspan=2>RAMALHO, V. F.; ALMEIDA, G. B. A responsabilidade do sócio administrador nos crimes fiscais. In: SEMIC, Seminário de Iniciação Científica, 23, 2015, Curitiba-PR. Anais do 23º Seminário de Iniciação Científica. Curitiba: PUCPR, 2015. p. DIRpb35.</td>
		...
		<tr>
			<td colspan=2 class="lt3"><font class="lt6">DIRpb35</font>
				<br><b>Direito Público</b></td>
		</tr>
		<tr>
			<td align="center"><font class="lt5"><b>A responsabilidade do sócio administrador nos crimes fiscais</b></font>
			<BR>
			<font class="lt4"><i>The managing partner liability in tax crimes</i></font>
			<BR>
			</td>
		</tr>
	</table>
	...
	<div style="text-align:right;">
		RAMALHO, Vinicius Ferreira<sup>1</sup>; ALMEIDA, Gabriel Bertin de<sup>2</sup>		<BR>
	...
	<table width="100%">
		<tr valign="top">
			...
			<div style="text-align:justify;">
				<P>
					<B>Introdução</B>: A responsabilidade dos sócios-administradores nos crimes de sonegação fiscal ou similar tem sido, em regra, interpretada de forma equivocada, sendo que a sua admissão no polo passivo ao menos dependeria de prova pré-constituída, isto é, sem que houvesse indícios razoáveis que apontassem o sócio-gerente como sendo autor dos crimes praticados, este é incumbido de comprovar nos autos processuais a sua não participação.
...
Ocorre que, ao responder um processo criminal, o indivíduo é automaticamente exposto a nítido constrangimento, observando que ao ser indiciado o indivíduo passa a constar nos arquivos criminais do Estado, existindo ainda certa “condenação pública”.					<B>Objetivo</B>: O objetivo deste artigo é mostrar que os princípios consittucionais de direito penal estão sendo violados. A principal ideia aqui é mostrar que atos simples de investigação são capazes de evitar todo o embaraço ,tais como como oitiva  de testemunhas que trabalharam na empresa.					<B>Metodologia</B>: Os métodos usados [e]#8203;[e]#8203;aqui são a interpretação das disposições legais , estudo sobre a jurisprudência , a posição da doutrina e como seria a correcta aplicação do direito processual penal , respeitando a dignidade dos direitos humanos.					<B>Resultados</B>: 					<B>Conclusões</B>: 				</P>
			...
			<div style="text-align:justify;">
				<P>
					<B>Introduction</B>: The Responsibility of the managing partner in the crimes of tax evasion has been interpreted in a wrong way.  It’s because the accuser, without any concrete evidence, charges the managing partner, imposing to him the obligation to prove that he didn’t commit any crime. It does cause a natural constraint, because this fact will be in the criminal files of the State, even if in the end of the process he has been found innocent. Also, there’s always the public condemnation, the society see’s this kind of situation with bad eyes.
