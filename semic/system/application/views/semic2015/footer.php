	...
	<table width="1024" align="center">
		...
		<tr valign="top">
			...
			<td width="25%">
				<b>SEMIC</b>
				<BR>
				<a HREF="<?php echo base_url('index.php/semic/about');?>" class="link_foot"><?php echo msg('about_system');?></A>
				<BR>
			...
			<td width="25%" >
				...
				<a href="http://www.solmarista.org.br/" target="_new"> 	
					<img src="<?php echo base_url('img/semic2015/marista_rede.png');?>" height="50" border=0> </a>
				&nbsp;&nbsp;
				<a href="http://www.centrodedefesa.org.br/" target="_new"> 	
					<img src="<?php echo base_url('img/semic2015/marista_defesa.png');?>" height="55" border=0> </a>
			</td>
			...
			<td width="25%">
				...
				<a href="http://www.fappr.pr.gov.br/" target="_new"> 
					<img src="<?php echo base_url('img/semic2015/logo_fa.png');?>" height="35" border=0> </a>
			</td>
			<!--Div IES -->
			<td width="25%">
				...
				<a href="http://www.senaipr.org.br/" target="_new"> 
					<img src="<?php echo base_url('img/semic2015/logo_senai_small.jpg');?>" height="20" border="0" style="position:absolute;"> </a>
