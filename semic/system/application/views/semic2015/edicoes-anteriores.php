	...
	<div class="text-3">
		...
		<div class="item-evento-anterior">
			...
			<div class="descricao-evento-anterior">
				...
				<p>
					O objetivo é promover o intercâmbio de conhecimento e práticas entre instituições,
					pesquisadores e bolsistas de Iniciação Científica, colocando em pauta pesquisa e inovação. Além de elevar a valorização de alunos de graduação e Pós-Graduação, e divulgar pesquisas
					desenvolvidas por eles sob a orientação de professores-pesquisadores e por fim estimular a adesão de alunos à atividade de investigação.
				</p>
				<p>
					Simultaneamente, a Pontifícia Universidade Católica (PUCPR) estará realizando seu XXII Seminário de Iniciação Cientifica (SEMIC) e o
					III Seminário de Iniciação Tecnológica e Inovação.
				</p>
			</div>
		</div>
		<!--SEMIC 2013 -->
