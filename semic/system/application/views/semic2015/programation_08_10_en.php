...
<div class="programacao-horario">
	...
	<div class="estilo_data4_1 celula-tabela-horario">
		...
		<p class="borda-programacao-cientifica">
			<span class="estilo-horario">08h30am to 10h00</span>am - <strong>Round table 7</strong>
			<br />
			<span class="tooltip tooltip-effect-5">
				<br />
				<strong>Title:</strong> <span class="tooltip-item">The right to motherhood and childhood</span>
				<br />
				<strong>Coordination:</strong> Patricia Elizabeth Benitez Romero
				<br />
	...
	<div class="estilo_data4_2 celula-tabela-horario">
		<!--- Bloco Mesa Redonda -->
		<p class="borda-programacao-cientifica">
			<span class="estilo-horario">10h30am to 12h00pm</span> - <strong>Round Table 8</strong>
			<br />
			<br />
			<span class="tooltip tooltip-effect-5"> 
				<strong>Title:</strong> <span class="tooltip-item">Protection networks and challenges in dealing with human rights violations of children and adolescents</span>
				<br />
	...
	<div class="estilo_data4_1 celula-tabela-horario">
		...
		<p class="borda-programacao-cientifica">
			...
			<br />
			<br />
			<span class="tooltip tooltip-effect-5"> <span class="tooltip-item">Scientific writing (Part 3)</span>
				<br />
				...
				<span class="tooltip-content clearfix">
					...
					<span class="tooltip-text"><b> Part 3 </b>
						...
						- Keep attention and player motivation - raising expectations;<br />
						- Require less the player's memory - reduce reading time;<br />
						- Establish a progression to a fluid reading - boost reading.</p>
	...
	<div class="estilo_data4_2 celula-tabela-horario">
		<p class="borda-programacao-intervalo">
			<span class="estilo-horario_intervalos">12h00pm to 14h00pm</span> - <strong>Lunch</strong>
			<br />
		</p>
	</div>
	<!--- Novo Bloco -->
	<div class="estilo_data4_1 celula-tabela-horario">
		<!--- Bloco Palestra -->
		<p class="borda-programacao-cientifica">
			<span class="estilo-horario">14h00pm to 15h00pm</span> - <strong>Closing</strong>
			<br />
			<br />
			<span class="tooltip tooltip-effect-5"> 
	...
	<div class="estilo_data4_2 celula-tabela-horario">
		<!--- Bloco Palestra -->
		<p class="borda-programacao-cientifica">
			<span class="estilo-horario">15h00pm to 16h00pm</span> - <strong>Awards</strong>
			<br />
			<br />
...
<script type="text/javascript">
	this.screenshotPreview = function() {
		...
		$("a.screenshot2").hover(function(e) {
			...
			$("#screenshot2").css("top", (e.pageY - xOffset) + "px").css("left", (e.pageX + yOffset) + "px").fadeIn("fast");
		}, function() {
			this.title = this.t;
			$("#screenshot2").remove();
		});
		$("a.screenshot2").mousemove(function(e) {
			$("#screenshot2").css("top", (e.pageY - xOffset) + "px").css("left", (e.pageX + yOffset) + "px");
		});
	};
</script>
