...
if ($form_id_av->saved > 0){
	$idAvaliador = $av->san_id_avaliador_com_verificador($dd[1]); #XXXFEIO do form
	$av->redireciona("seleciona_trabalho", array("idAvaliador" => $idAvaliador));
}
