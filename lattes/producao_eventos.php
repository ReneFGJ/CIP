...
require($include.'sisdoc_debug.php');
	...
	echo '<h1>Trabalhos apresentados em eventos pelos Docentes da Pós-Graduação</h1>';
	echo '<h3>Período de '.$anoi.' até '.$anof;
	$sr = $lattes->resumo_qualis_ss_tipo_geral(0,$areas,$anoi,$anof,'E');	
