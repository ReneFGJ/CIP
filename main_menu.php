...
if ($perfil->valid('#SEP#SPG'))
	{
		array_push($mn,array('Secretaria dos programas de Pós-Graduação','b1','pos/','Secretaria PPG','icone-iniciacao-cientifica',''));
	}
if (!($perfil->valid('#CNQ')))
	{
...
if ($perfil->valid('#ADM'))
	{ array_push($mn,array('Administração do sistema','b1','admin/','Administração','')); }
if ($perfil->valid('#CSF'))
	{ array_push($mn,array('Ciência Sem fronteiras','b1','csf/','CSF','')); }
