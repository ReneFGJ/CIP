...
<html>
    <head>
    	<title>Applying - Ciência sem Fronteiras | PUCPR</title>
        <meta charset="utf-8">
	...
	<body>
		...
		<div id="total" class="total">
			...
			<div id="corpo">
				  <h1>I want to a<span class="lt6light">pply</span></h1>
				 	<p>Check your information below and answer to the questions to apply to Science without Borders Program here in PUCPR.</p>
				 		...
				 		<div id="dados-puxado-alunos">
				 			...
				 			<table class="tabela-dados-pessoais">
				 				...
				 				<tr class="lt3">
				 					...
				 					<td><strong>Card Number (PUCPR)</strong>
				 						<br />99229292929
				 					</td>
				 				</tr>
				 				<tr class="lt3">
