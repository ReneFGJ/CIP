      ...
      <div class="container">
        ...
        <div class="depoimento-total">
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-falavinha.jpg" class="foto-depoimento borda-img-2014" />
                <h3>Bruna Cristina Falavinha</h3>
                <h4>Estados Unidos, San Diego - University of California</h4>
                <span class="botao-curso-depoimento">Ciências Biológicas</span>
                <p>Se eu pudesse dar um conselho para alguém que está em dúvida entre fazer ou não um intercâmbio, eu diria: - Simplesmente vá! Largue seus medos e inseguranças que um mundo incrível está a sua espera. Cheguei aqui sem falar muito bem inglês, então fiz um curso de inglês de 6 meses. Fácil? NÃO! Quem chegou aqui tendo uma boa base de inglês teve muito mais facilidade, então eu aconselharia estudar bastante e tentar aprender o máximo possível antes de viajar. As melhores universidades pedem uma nota no TOEFL super alta, aqui na UCSD tivemos 20 semanas de curso para tirar 90 no TOEFL iBT, e quem conhece o nível de dificuldade do teste, sabe que não é fácil alcançar esse score em tão pouco tempo. Aqui nos Estados Unidos, principalmente na Califórnia, existem pessoas de todos os cantos do mundo, e quando eu digo todos, sim, são todos mesmo! Conheci japoneses, chineses, coreanos, árabes, indianos, turcos, alemães, americanos, suicos, italianos, franceses, egípcios, noruegueses, kuaitianos, e de países que eu nem conhecia. Aprendi muita coisa com isso, tive que me adaptar não só a cultura americana, mas a culturas completamente diferentes da nossa, como a Árabe por exemplo. Não foi fácil no começo, mas no fim das contas acabamos percebendo que todos somos diferentes de qualquer forma e que respeitar a opinião e o ponto de vista dos outros é fundamental.</p>
                 
                <p>E o que mais interessa, as aulas e a universidade: você pode escolher as matérias que sempre quis fazer! Foi o que eu fiz no caso, ou pode tentar pegar algumas para eliminar da sua grade na universidade brasileira. Os professores são ótimos, tive a honra de ter aula com um professor que já tinha recebido um prêmio Nobel e vários outros prêmios, inclusive das mãos do presidente Obama. 
                Escolhi estudar neurociência, que não tinha muita oportunidade no Brasil. As aulas não estão sendo nada fáceis, e tenho que estudar como nunca. Além disso, as notas aqui são um pouco diferente, se você tirar 74, significa que você tirou um C e está reprovado pelo programa de estudantes internacionais da UC (é uma nota baixa, mas normalmente você seria aprovado se fosse um aluno normal). Se você tirar 85 (B) é considerado um aluno "na média". Tirar uma boa nota, significa que você precisa tirar acima de 94 (A ou A+).</p>
            </div>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                ...
                <h4>Austrália, Melbourne - Swinburne University of Technology</h4>
                <span class="botao-curso-depoimento">Publicidade e Propaganda</span>
                <p>"Descrever as experiências mais incríveis de meu intercâmbio na Austrália é uma tarefa muito difícil, uma vez que cada novo dia vivido lá era sempre uma nova aventura ou desafio a enfrentar. Desde a aadptação à um novo ambiente, novos costumes e novas pessoas até a despedida de amigos e colegas queridos, me deparei com muitas situações que jamais esperaria que acontecessem comigo caso estivesse no Brasil, como morar com uma família australiana e ter que "aprender" a comer noodles todo dia, fazer mais amigos asiáticos do que australianos mesmo estando na Austrália, descobrir que cangurus não vivem soltos nas ruas das cidades e que coala é o animal mais fofo que já conheci. Além destas curiosidades, posso dizer que os novos conhecimentos que pude adquirir numa universidade australiana me enriqueceram tanto pessoalmente quanto profissionalmente. Enfim, é um privilégio poder aplicar e compartilhar diariamente tudo o que aprendi em um ano e meio fora do país. Por isso, é com muito orgulho que digo: eu sou uma ex-bolsista Ciência sem Fronteiras."</p>
            </div>

            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-gabriel-cordeiro.jpg" class="foto-depoimento borda-img-2014" />
                <h3>Gabriel de Oliveira Cordeiro</h3>
                <h4>Reino Unido, Glasgow - University of Strathclyde</h4>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                ...
                <h4>Austrália, Sydney - University of Technology Sydney</h4>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                ...
                <h4>Austrália, Sydney - Macquarie University</h4>
                <span  class="botao-curso-depoimento">Ciências Biológicas</span>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                ...
                Escuto muitos de meus colegas argumentando que nao fariam um intercambio pois nao querem atrasar um ano da faculdade, porem eu nao me arrependo de ter "atrasado" um ano e meio na faculdade. Alem da oportunidade de conhecer novos lugares, novas pessoas e fazer novos amigos, as experiencias que tive no exterior serao inesqueciveis e com certeza contribuiram muito para minha formacao, pois um profissional nao eh um tecnico mas sim uma combinacao de todos os seus conhecimentos pessoais e claro, os academicos."</p>
            </div>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-mariane.jpg" class="foto-depoimento borda-img-2014" />
                <h3>Mariane Volce</h3>
                <h4>Alemanha, Deggendorf - Technisch Hochschule Deggendorf</h4>
                <span  class="botao-curso-depoimento">Engenharia Química</span>
                <p>"Morar no exterior foi uma aventura total. Sair do aeroporto e procurar o hostel, posso dizer que foi minha primeira e inesquecível experiência na Alemanha. Achava que seria uma missão quase impossível, porém, muito pelo contrario, vários alemães estavam dispostos em me ajudar, tornaram tudo fácil e meu amor pela Alemanha florescer."</p>
            </div>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                ...
                <h4>Alemanha, Ilmenau - Technische Universität Ilmenau</h4>
                <span  class="botao-curso-depoimento">Engenharia Mecânica</span>
                <p>"O meu ano de intercâmbio na Alemanha foi muito bem aproveitado, com muitas metas alcançadas. Além de novas amizades e viagens a diversos locais, foi possível estar inserido em uma cultura e universidades diferentes, com novas atividades e muitos novos conhecimentos. Como exemplo posso citar a participação na equipe de carros fórmula da universidade e participação em uma das competições mais importantes da categoria na Europa e no mundo, com equipes de diversos países. Além disso, realizei estágio na BMW em Munique, onde tive muitos aprendizados e pude estar totalmente em contato com a cultura e modo de trabalho em uma grande empresa."</p>
            </div>

            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-mayara-moser.jpg" class="foto-depoimento borda-img-2014" />
                <h3>Mayara Stephanie Vieira Moser</h3>
                <h4>Alemanha, Kempten, Allgäu - Hochschule Kempten University of Applied Sciences</h4>
                <span  class="botao-curso-depoimento">Engenharia Mecânica</span>
                <p>"Meu intercâmbio na Alemanha está sendo fantástico. A oportunidade oferecida pelo programa Ciência sem Fronteiras  é única tanto para o desenvolvimento acadêmico como para o crescimento pessoal. Os seis primeiros meses na escola de línguas Hermann Hesse Kolleg, no meio da floresta negra, foi essencial para aprender a língua e a cultura alemã. Atualmente curso engenharia mecânica  na Hochschule Kempten University of Applied Sciences onde estou aprendendo muitas ideias novas que futuramente posso utilizar quando eu voltar para o Brasil.
                Se houver outra oportunidade de um novo intercâmbio com certeza irei mostrar interesse."</p>
            </div>

            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-natalia-aubrift.jpg" class="foto-depoimento borda-img-2014" />
                <h3>Natalia Aubrift de Lara e Silva</h3>
                <h4>Alemanha, Lüneburg - Leuphana Universität</h4>
                <span  class="botao-curso-depoimento">Engenharia Ambiental</span>
                <p>"Intercâmbio é um ano a parte na vida de quem viaja. As experiências são únicas, os segundos são memoráveis e as pessoas que cruzam o caminho são inesquecíveis. Tudo contribui para que o tempo que o intercambista passa longe de casa, seja o melhor. Intercâmbio é um tempo de auto-conhecimento e de descobertas de novas culturas. O meu ano Julho a Julho 2014-15, foi um desses incríveis momentos na minha vida. É muito engraçado como cada intercâmbio é diferente. Esse foi o meu terceiro intercâmbio mas as sensações me fazem pensar que foi o primeiro. Especialmente intercâmbio universitário é tudo diferente, e dessa vez o foco foi muito mais profissional e com objetivos para um futuro não tão distante. Dessa vez, fui consciente dos meus deveres e o que eu gostaria de plantar para colher os frutos depois. Conheci muitas pessoas boas, aprendi ainda mais sobre a cultura alemã e aprimorei o idioma. Mas acima de tudo esse intercâmbio vai fazer muita diferença na minha vida acadêmica e profissional. No primeiro semestre desse ano na Alemanha eu direcionei à Universidade. Fiz o máximo de matérias que eu poderia, investi meu tempo em estudos, viagens e novas amizades. Aproveitei cada segundo pra fazer dessa experiência a melhor. E valeu muito a pena. Passei em todas as matérias, conheci lugares incríveis e pessoas maravilhosas que vou levar pra sempre. Em cada saída de campo eu voltava mais motivada e pensando em como eu tenho sorte em ter visto tudo que vi. No segundo semestre o foco foi um estágio. Não descansei até tentar todas as oportunidades possíveis, afinal fazer estágio no exterior rende um upgrade no currículo e tem tudo para ser uma experiência de muito aprendizado. Além do mais, o principal objetivo do Ciências Sem Fronteiras é importar conhecimento para fazer o Brasil crescer. Pensando nisso fui atrás e consegui. Meu estágio foi no terceiro maior Instituto de Pesquisa da Alemanha, o Helmholtz-Zentrum, onde eu tive a incrível oportunidade de fazer pesquisas sobre o Hidrogênio como energia renovável. Além de poder conhecer o estilo de trabalho alemão, fazer pesquisas práticas e teóricas, ter meu nome em um artigo que será publicado em um jornal internacional, eu tirei desse estágio o tema para o meu TCC (que inclusive comecei a escrever nos intervalos do meu trabalho). De tudo o que eu vivi, hoje eu sei que as oportunidades estão sempre disponíveis, o que precisa ser feito é correr atrás delas e não desistir. O meu intercâmbio me fez crescer muito em todos os sentidos, nunca vou esquecer essa experiência e sei que logo colherei os frutos. Todo o esforço valeu a pena, porque acima de tudo (aulas, estágio, viagens, novos amigos, aprendizado), vou acabar o ano sabendo que fui muito feliz."</p>
            </div>

            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-pamela-golin.jpg" class="foto-depoimento borda-img-2014" />
                <h3>Pamella Golin Guarinello</h3>
                <h4>Áustralia, Sydney - Sydney University</h4>
                <span  class="botao-curso-depoimento">Engenharia Civil</span>
                <p>"Durante a minha experiência em intercâmbio pelo Ciências Sem Fronteiras  tive a oportunidade de realizar o que sempre foi um sonho pra mim: conhecer a Áustralia. Além do lugar em que vivi pude viajar dentro do país conhecendo praias e cidades fantásticas, além de gente de todas as partes do mundo! Vivi a experiência de morar sozinha em um apartamento de estudante, com direito a toda independência que qualquer jovem sonha em ter. Acredito ter aprendido muito durante meu ano no exterior e mesmo se pudesse não mudaria absolutamente nada, aprendi com minhas dificuldades e cresci com meus erros."</p>
            </div>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-rodrigo-brito.jpg" class="foto-depoimento borda-img-2014" />
                <h3>Rodrigo de Brito</h3>
                <h4>Austrália, Townsville - James Cook University of North Queensland</h4>
                <span  class="botao-curso-depoimento">Fisioterapia</span>
                <p>"Intercâmbio não é mais um ano de vida e sim a vida em um ano!". Essa frase resume bem minha experiência no exterior, nos 18 meses que vivi em Townsville na Austrália pelo Ciência sem Fronteiras, com toda certeza eu aprendi muito mais do que no resto da minha vida toda. Tive a oportunidade incomensurável de viver em um país maravilhoso e estudar em uma das melhores universidades do mundo, bem como vivenciar culturas diferentes (Asiáticas, Européias e etc) que me fez crescer muito como cidadão, também fiz amizades com pessoas de países que eu nem mesmo sabia que existiam. Além de tudo isso, ainda pude viajar nas férias e conhecer lugares fantásticos como a própria Austrália, Nova Zelandia, Tailandia, Singapura e Indonésia. Resumindo, intercambio é uma caixinha de surpresas maravilhosas embaladas em 6, 12 ou 18 meses."</p>
            </div>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                ...
                <h4>Canadá, Kitchener, Ontário - Conestoga College</h4>
                <span  class="botao-curso-depoimento">Engenharia Civil</span>
            ...
            </div> <!-- fecha div depoimento total -->
        
        <span class="estilo-ano-turma-2013">Turma de 2013</span>

        <div class="depoimento-total">
            
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-ana-vasques.jpg" class="foto-depoimento borda-img-2013" />
                <h3>Ana Amélia Mondin Vasques</h3>
                <h4>Irlanda, Dublin - Dublin Business School</h4>
                <span  class="botao-curso-depoimento-2013">Arquitetura e Urbanismo</span>
                <p>"A oportunidade de intercambio pelo Ciências Sem Fronteiras foi uma das experiências mais marcantes na minha vida, tanto no sentindo professional quanto e principalmente no pessoal. Conhecer novas pessoas, novos lugares e culturas foi crucial para meu amadurecimento e visão da sociedade, analisar com outros olhos meu país e almejar caminhos que levem a melhorias para o mesmo, e conhecimentos que temos a compartilhar, tanto que pude perceber que o Brasil e nós brasileiros temos muito a aprender mas também muito a ensinar.
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                ...
                <span  class="botao-curso-depoimento-2013">Engenharia de Controle e Automação</span>
                <p>"A possibilidade de intercâmbio através do Ciência sem Fronteiras foi uma das melhores escolhas da minha vida. Houve muito aprendizado durante os 18 meses no Canadá. Não apenas acadêmico, mas, principalmente, cultural. Vivenciar a cultura canadense me mostrou o quanto o Brasil esta defasado culturalmente, onde lá - país de primeiro mundo - a educação é algo essencial para qualquer profissional de qualquer área. Enfim, a oportunidade de intercâmbio pelo CsF além do contato e vivência da cultura do país de destino, faz com que o estudante se envolva ainda mais, pois o programa conta com um período de estágio e/ou pesquisa na qual o aluno deve se comprometer a desenvolver e entregar resultados, e, em particular no meu caso, desenvolver equipamentos e dispositivos que possam ajudar e auxiliar o tratamento de câncer de próstata através de um novo método - o HIFU(High Intensity Focused Ultrasound), tratamento não invasivo e tão eficiente quanto os métodos tradicionais. Acredito que esta experiência tenha sido a mais marcante entre todas as vivenciadas no Canadá."</p>
            </div>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                ...
                <h4>Irlanda, Sligo - Institute of Technology of Sligo</h4>
                <span  class="botao-curso-depoimento-2013">Farmácia</span>
                <p>"Não há valor material que quantifique a experiência adquirida, não apenas profissional mas também pessoal. Conheci a mim mesmo, desenvolvi talentos, descobri qualidades, identifiquei defeitos.
                Aprendi uma língua estrangeira, desafiei meus medos e ganhei deles. Um novo mundo abriu em minha mente, não há mais limites, não há mais paradigmas, não há mais preconceitos. O contato com o exterior e nisso inclui brasileiros de outras regiões também, mostra que o universo da diversidade é imenso e devemos respeitar isso e ser curiosos pra encarar, sair da zona de conforto e curtir as oportunidades."</p>
            </div>

            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-guilherme.jpg" class="foto-depoimento borda-img-2013" />
                <h3>Guilherme Nack Cordeiro</h3>
                <h4>Reino Unido, Uxbridge - Brunel University</h4>
                <span  class="botao-curso-depoimento-2013">Engenharia da Computação</span>
                <p>"Não há palavras para descrever a sensação que senti antes de entrar naquele avião, mas as 11h de viagem passaram voando(literalmente), e algumas horas depois, eu estava lá, prestes a viver alguns dos melhores momentos da minha vida. Eu não posso limitar a minha experiência de intercâmbio pelo Ciências sem Fronteiras apenas como uma experiência acadêmica, não, esse ano foi muito além disso, muito além de tudo que eu imaginava. Um intercâmbio nos proporciona a oportunidade de ir a lugares totalmente novos, conhecer pessoas diferentes e a explorar diversas culturas, um intercâmbio é a melhor forma de se poder viver, viver de verdade, viver de maneira independente e única o mundo que nos rodeia. Se eu faria outro intercâmbio? Sim, é só falar a data e hora que eu vou correndo."</p>
            </div>

            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-igor-deitos.jpg" class="foto-depoimento borda-img-2013" />
                ...
                <p>"A experiência mais legal que eu tive no meu intercâmbio foi o aprendizado de novas culturas. Quando decidi fazer um intercâmbio e depois escolher o país de destino, eu queria passar por experiências que eu nunca passaria no Brasil, então resolvi viver em uma Homestay (casa de família). Além de aprender a cultura Norte Americana, aprendi muito a cultura Judaica, pois minha Homestay me ensinou muito a cultura deles (me adotaram como um membro da família), pois participava como se fosse um membro da família. Outra experiência bacana que eu tive, foram os hábitos, culturas da população e o clima do país. Toronto é uma cidade conhecida mundialmente como uma Cidade multicultural, então era muito normal você estar dentro de um metrô e ver/ouvir diversas línguas. A vida acadêmica foi totalmente diferente da de costume aqui no Brasil, metodologias totalmente diferentes e estilos acadêmicos diferentes, os professores tem uma relação muito mais fria com os alunos, aquele tira dúvida, levantar a mão e perguntar, não existe."</p>
            </div>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                ...
                <span  class="botao-curso-depoimento-2013">Engenharia de Produção</span>
                <p>"Durante o intercâmbio CsF, aprendi muito, fiz amigos para toda vida, conheci lugares novos e tive experiências únicas. Por ter vivido um ano na Finlândia, pude aprender um pouco o idioma finlandês e de vivenciar a cultura local, sendo ambos completamente diferentes do que temos no Brasil. Lá também convivi com pessoas das mais diversas nacionalidades - Finlandeses, Russos, Poloneses, Iranianos, Nepaleses, Chineses, Alemães, Italianos entre outros - cada um com seus particulares hábitos e pontos de vista, enriquecendo minha visão sobre o certo e o errado. Na universidade, tive a oportunidade de expandir meus conhecimentos com disciplinas que são diferentes das lecionadas aqui. Para completar, durante esse ano de intercâmbio, consegui presenciar uma Aurora Boreal (foto), fenômeno raro e maravilhoso que só acontece nas regiões mais ao Norte do planeta."</p>
            </div>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                ...
                <h4>Reino Unido, Aberdeen - University of Aberdeen</h4>
                <span  class="botao-curso-depoimento-2013">Odontologia</span>
                <p>"Participar do Ciência sem Fronteiras foi, sem dúvida, a experiência mais culturalmente enriquecedora que eu tive. Além de encarar um sistema acadêmico completamente diferente, foi muito interessante interagir com os Britânicos e perceber como a sociedade deles reage: diferente do Brasil, toda a Europa convive com uma grande multiplicidade de nacionalidades. Eu era tão estrangeiro quanto o pessoal da Escandinávia, da China, da Índia, etc... Isso me fez ver o quão grande e diversificado o mundo é, muito mais do que eu podia conceber.
                O CsF, sem dúvidas, além de abrir portas (acadêmica, profissional e culturalmente), também abre a sua cabeça pra um mundo muito mais complexo, rico e interessante."</p>
            </div>

            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/depoimento-rafael-dias.jpg" class="foto-depoimento borda-img-2013" />
                <h3>Rafael Alexandre Navas Dias</h3>
                <h4>Alemanha, Duisburg - Universitaet Duisburg-Essen</h4>
                <span  class="botao-curso-depoimento-2013">Engenharia Mecânica</span>
                <p>"Bem, gostaria de dizer que o ano em que estive na Europa foi uma realização pessoal sem precedentes, auto gestão, superação de barreiras (linguísticas e culturais), viagens extraordinárias e muitas felicidades."</p>
            </div>
            ...
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/tiago-costa.jpg" class="foto-depoimento borda-img-2013" />
                <h3>Tiago Hilbert Gouvea da Costa</h3>
                <h4>Holanda, Amsterdã - VU University Amsterdam</h4>
                <span  class="botao-curso-depoimento-2013">Engenharia de Produção</span>
        ...
        <span class="estilo-ano-turma-2012">Turma de 2012</span>
        <div class="depoimento-total">
           
            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/allan.jpg" class="foto-depoimento borda-img-2012" />
                <h3>Allan Adley Fagundes Amorim</h3>
                <h4>Estados Unidos, The University of North Carolina at Charlotte</h4>
                <span  class="botao-curso-depoimento-2012">Engenharia Elétrica</span>
                <p>"O que posso dizer quanto à primeiras impressões, é que o povo é bem mais receptivo que eu esperava. Sempre tinha a imagem do americano querendo ser melhor que todos(e de fato tem alguns que pensam assim), mas quando você fala que é do Brasil, sei lá, a coisa muda, eles querem saber do nosso futebol, da nossa comida, de como somos calorosos e alegres. Ser brasileiro hoje em dia é motivo SIM de muito orgulho pra gente. NUNCA deixem de depois de dizer teu nome, falar "I am from Brazil", fiz essa experiência e notei que o papo toma um rumo mais descontraído. Nos primeiros dias ficava impressionado com tudo, aqui tudo é exagerado, parece que tudo vem de Itú...hehehehe...os Prédios da facu parecem castelos, os copos no fast-food que aqui é small pra gente no Brasil são os Extra-large, e os Large aqui dá pra uma família no Brasil. Vocês vão estranhar dimaaaaaaaaais a comida, sério, pra quem gosta de um feijão, arroz e bife todo dis no almoço, nos primeiros dias vai ser tenso, mas depois você se habitua. Café, aaaaaaah saudade do nosso café, com um pãozinho de queiijo...hummmmmmmmmmmm...mas temos que dançar de acordo a música, estou aqui e tenho que me acostumar...vocês vão ficar abismados como somos um povo que é explorado e tão feliz ao mesmo tempo, roupas, eletrônicos carros e calçados aqui parece que estão sempre em promoção, mas não, a carga tributária aqui não é exploratória! Ops, acho que o resto vocês devem descobrir por si mesmos...Boa sorte nessa nova empreitada da vida de todos vocês...será uma experiência pra toda vida, REALLY!!!"</p>
            </div>

            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/chris.jpg" class="foto-depoimento borda-img-2012" />
                <h3>Christiane Scheidt Friedrich</h3>
                <h4>Alemanha, Georg August Universitat Gottingen</h4>
                <span class="botao-curso-depoimento-2012">Engenharia de Alimentos</span>
                <p>"Creio que só o fato de sair de casa, independente para onde for, morar sozinho, sem os pais, já é um grande aprendizado. Foi a primeira vez que tive que literalmente me virar sozinha, e confesso que no começo fiz algumas bobagens e erros, que com o passar do tempo vão se tornando mais raros e agora, depois de mais de seis meses longe, percebo o quanto cresci e aprendi com tudo que vivenciei aqui. A Alemanha é um lugar simplesmente incrível, toda a história por trás dos lugares, a comida, as pessoas, eu fico cada vez mais maravilhada com tudo. Dizem que os alemães são frios, chatos, e alguns realmente são, mas esse tipo de gente tem em todos os lugares, independente de onde você vá, mas a maioria é super. Querida, disposta a ajudar quando você precisar. Se você não falar bem o alemão, não tem problema, as pessoas sabem bem o inglês e só quem tem um pouco de dificuldade que fica meio ranzinza na hora de ajudar, mas não significa que não ajudem. O meu programa está sendo voltado para a execução de projetos no laboratório, tive a oportunidade de assistir apenas duas matérias, as quais não contarão quando eu voltar, pois aqui estou imersa em outro curso. Mas de qualquer forma, o reconhecimento no papel não é nada comparado com o que estou aprendendo, não só em assuntos acadêmicos, mas também na vida pessoal. Recomendo muito a Alemanha, na verdade, recomendo qualquer lugar, acho uma experiência única fazer um intercâmbio e essa chance não deve ser desperdiçada."</p>
            </div>

            <div class="depoimento-pagina" data-sr="enter bottom, hustle 10px">
                <img src="img/depoimentos-fotos/eduardo.jpg" class="foto-depoimento borda-img-2012"/>
                <h3>Eduardo Martelli Moreira</h3>
                <h4>Holanda, Erasmus University Rotterdam</h4>
                <span  class="botao-curso-depoimento-2012">Medicina Veterinária</span>
                <p>"Deus criou o mundo, e os holandeses criaram a Holanda" - acrescento que fizeram um ótimo trabalho. Percebe-se em todo lugar a preocupação com a qualidade de vida, desde concertos nos canais e cinemas ao ar livre à uma extensiva rede de transporte público cobrindo toda a cidade e todo o país. Viver abaixo do nível do mar (em alguns lugares, mais de 10 metros!) não é motivo para os holandeses viverem cabisbaixos - ao contrário, são acolhedores e não perdem uma oportunidade de festar, seja com quem for e da onde for. Aliás, estudantes estrangeiros abundam pelo campus e pela cidade - sérvios, iranianos, colombianos, chineses, canadenses, franceses, o que for. </p>
                <p>A quem escolher vir para cá, tenho algumas dicas. Preste bastante atenção aos procedimentos para conseguir os vistos de entrada e de residência, mesmo sem erros na papelada, o processo pode demorar e você pode acabar perdendo alguns dias de aula. Procure arranjar também um lugar para morar antes de chegar ao país - poupa muito tempo e dor de cabeça. Finalmente, compre o ov-chipkaart logo, não só pode-se usá-lo em toda a Holanda para andar de trem, tram, metro e ônibus, mas também as tarifas ficam mais em conta. 
                A Holanda é um país incrível, muito além de coffee shops e do Red Light District. Vir para cá é uma experiência inigualável, morar aqui, inesquecível."</p>
            </div> 
