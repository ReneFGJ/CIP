...
<html lang="br ">
	...
	<body style="background-color:#a6272f;">
		...
		<div class="wrapper">
			...
			<div class="row">
			<div class="col-md-6">
			<h2 style="color:#fff; margin: 30px 0 30px;">Inscreva-se pelo site at̩ o </br>
			...
			<!-- imagem temporaria -->
			<div class="section">
				<div class="container-fluid" style="background-color:rgb(166, 39, 47);">
					<div class="container">
						<a name="programacao"> </a>
			...
			<div class="section">
				<div class="container-fluid" style="background-color:rgb(166, 39, 47);">
					<div class="container">
						<h2 style="color:#a6272f; padding-left:10px;"><strong><a name="contato">Contato</a></strong></h2>
						<p style="color: #fff;">
