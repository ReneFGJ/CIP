<div id="page10" class="page_min pg10">
	...
	<table width="900" align="center">
		...
		<tr>
			...
			2. Capela
			<BR>
			3. Centro Administrativo / Reitoria
			<BR>
			4. Biblioteca Central
			<BR>
			5. Museu / Concha Acústica
			<BR>
			6. Clínicas Odontológicas
			<BR>
			7. Pastoral
			<BR>
			8. Centro de Teologia e Ciências Humanas - CTCH
			<BR>
			n.. Centro de Ciências Jurídicas e Sociais - CCJS
			<BR>
			9. Centro de Ciências Exatas e de Tecnologia - CCET
			<BR>
			10. Centro de Ciências Biológicas e da Saúde - CCBS
			<BR>
			11. Projeto Social Champagnat
			<BR>
			12. Farmácia Industrial
			<BR>
			13. Laboratórios de Engenharia Civil e Mecânica
			<BR>
			14. Labaratórios de Engenharia Elétrica e Informática
			<BR>
			15. Laboratório de Engenharia de Alimentos
			<BR>
