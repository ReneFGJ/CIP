...
Email
<br />
<input class="input-inscricao" name="dd2" value="<?php echo $dd[2]; ?>">
</input>
<br />
...
<br />
<input class="input-inscricao" name="dd3" value="<?php echo $dd[3]; ?>">
</input>
<br />
...
<br />
<input class="input-inscricao" name="dd4" value="<?php echo $dd[4]; ?>">
</input>
<br />
